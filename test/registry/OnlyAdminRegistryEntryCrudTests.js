...
contract("OnlyAdmin Registry Entry Crud Tests", (accounts) => {
    ...
    it("#1 should allow admin to add new entry with enough fee", async () => {
    ...
    it("#2 should not allow registry owner to add new entry with enough fee", async () => {
    ...
    it("#3 should not allow unknown to add new entry with enough fee", async () => {
    ...
    it("#4 should not allow registry admin to add new entry without enough fee", async () => {
    ...
    /*  -------------------------------- Delete Entry -----------------------  */
    it("#6 should allow registry admin to delete entry", async () => {
    ...
    it("#7 should not allow registry owner to delete entry", async () => {
        const newEntryId = await registry.createEntry(REGISTRY_ADMIN_ACCOUNT)
        await registry.containsEntry(newEntryId).should.eventually.equal(true)
    ...
    it("#8 should not allow unknown to delete entry", async () => {
        const newEntryId = await registry.createEntry(REGISTRY_ADMIN_ACCOUNT)
        await registry.containsEntry(newEntryId).should.eventually.equal(true)
