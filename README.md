...
cyber•Fund's Team in short time will make review on your work and will commit changes
...
dependencies = ["independent"] # Name of the system 
icon = "system_logo_icon" # Name of icon without extension
```
